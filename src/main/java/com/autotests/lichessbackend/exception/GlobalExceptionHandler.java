...
public class GlobalExceptionHandler {
    ...
    public Map<String, Object> handleNotFound(NotFoundException exception) {
        ...
        return Map.of("timestamp", Instant.now(), "status", 404, "error", "Not Found", "message", exception.getMessage());
    }
    ...
    public Map<String, Object> handleSyncException(SyncException exception) {
        ...
        return Map.of("timestamp", Instant.now(), "status", 502, "error", "Sync Error", "message", exception.getMessage());
    }
    ...
    public Map<String, Object> handleValidationException(MethodArgumentNotValidException exception) {
        ...
        return Map.of("timestamp", Instant.now(), "status", 400, "error", "Validation Failed", "message", "Request validation failed", "fieldErrors", fieldErrors);
    }
    ...
    public Map<String, Object> handleGeneralException(Exception exception) {
        ...
        return Map.of("timestamp", Instant.now(), "status", 500, "error", "Internal Server Error", "message", exception.getMessage());
    }
}